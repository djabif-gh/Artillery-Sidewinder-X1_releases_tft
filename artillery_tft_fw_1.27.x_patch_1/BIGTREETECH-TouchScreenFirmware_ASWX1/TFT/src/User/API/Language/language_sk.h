...
#define _LANGUAGE_SK_H_
    ...
    #define STRING_SETTINGS_RESET_DONE    "Reset všetkých nastavení vykonaný. Pre správne fungovanie, prosím,\nreštartovať zariadenie."
    ...
    #define STRING_IS_PAUSE               "Nemožno extrudovať počas tlače,\npozastaviť tlač?"
