...
#define _LANGUAGE_UK_H_
    ...
    #define STRING_PID_START_INFO         "Зараз буде почато PID автоналаштування, це займе деякий час. Продовжити?"
    #define STRING_PID_START_INFO_2       "Автоналаштування PID в дії!"
    #define STRING_PID_START_INFO_3       "Не чіпайте екран до закінчення налаштування (LED засвітиться зеленим)!"
